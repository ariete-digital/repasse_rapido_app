    ...
    <Container>
      <ImgBackground source={sell24} alignItems='flex-start'>
        <DataContainer width='60%'>
          ...
          <View style={{ width: '50%' }}>
            <GradientButton onPress={() => openUrl('https://www.repasserapido.com.br/venda-rapida')}>
    ...
    <Container>
      <ImgBackground source={assessoria} alignItems='flex-end'>
        <DataContainer width='65%'>
          ...
          <View style={{ width: '50%' }}>
            <GradientButton onPress={() => openUrl('https://www.repasserapido.com.br/assessoria')}>
              <Text color='white'>Saiba Mais</Text>
            </GradientButton>
          </View>
        </DataContainer>
    ...
    <Container>
      <ImgBackground source={advogado} alignItems='flex-end'>
        <DataContainer width='50%'>
          ...
          <MoreInfo onPress={() => openUrl('https://www.repasserapido.com.br/advogado')} />
        </DataContainer>
      </ImgBackground>
    </Container>
    ...
    <Container>
      <ImgBackground source={seguro} alignItems='flex-start'>
        <DataContainer width='55%'>
          ...
          <MoreInfo onPress={() => openUrl('https://www.repasserapido.com.br/seguro')} />
        </DataContainer>
      </ImgBackground>
    </Container>
  )
